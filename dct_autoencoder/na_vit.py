...
class NaViT(nn.Module):
    def __init__(self,
                 image_size:int, patch_size:int, dim:int, depth:int, heads:int, mlp_dim:int, channels:int = 3, dim_head:int = 64, dropout:float = 0., emb_dropout:float = 0., pos_embed_before_proj:bool=True):
        super().__init__()
    ...
    def forward(
        ...
        patches, h_indices, w_indices, attn_mask = _input.patches, _input.h_indices, _input.w_indices, _input.attn_mask
